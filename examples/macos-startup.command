...
# 5. Optional: set RUNNER_SESSION_CACHE_FILE to change the local provider cache path
...
screen -dmS worker bash -c 'cd ~/openclaw-worker && WORKER_URL=http://YOUR_CLOUD_IP:3456 WORKER_TOKEN=YOUR_TOKEN RUNNER_SESSION_CACHE_FILE=/tmp/openclaw-runner-session-cache.json node worker.js'
